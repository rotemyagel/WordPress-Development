...
<main id="site-content" role="main">
    ...
    <div class="container">
        <div class="row my-5">
            ...
            <div class="col-lg-6">
                <h1 class="mt-0 mb-5"><?php echo $product_title ?></h1>
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <?php if($product_price[0]){ ?>
                                <h2 class="col-6 price my-0 <?php echo $product_sale_price[0] ? 'disabled' : 'ml-0' ?>"><?php echo $product_price[0] . ' $'; ?></h2>
                            <?php } ?>
            ...
            <div class="col-md-12">
                <div class="desc mt-4">
                    ...
                    <?php if($product_youtube[0]){ ?>
                        <div class="embed-container"><iframe src="<?php echo $product_youtube[0]; ?>" frameborder="0" allowfullscreen></iframe></div>
                    <?php } ?>
                </div>
            </div>
            <div class="col-md-12">
...
<a href="<?php echo get_the_permalink($post->ID); ?>" class="product-link col-md-4 col-md-6 col-xs-12 mb-4">
